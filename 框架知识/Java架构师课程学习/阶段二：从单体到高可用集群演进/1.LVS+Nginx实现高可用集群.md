...
4. 创建子接口（这样做是为了创造一个虚拟ip，后面使用keepalived搭建主备LVS后就无需这一步了）
   ...
   4. 查看网络配置：`ip addr`，如下图所示说明子接口配置完成。
      ...
      ![](E:\markdown笔记\笔记图片\20\2\41.png)

5. 安装LVS的管理工具ipvsadm：`yum install ipvsadm`。安装完成后，使用`ipvsadm -Ln`，如下图说明安装成功。

   ![](E:\markdown笔记\笔记图片\20\2\42.png)

6. 课程安装图片

   ![](E:\markdown笔记\笔记图片\20\2\43.png)
...
2. 配置虚拟网络子接口（环回接口）
   ...
   4. 查看网络配置：`ip addr`，如下图所示说明环回接口配置完成。
      ...
      ![](E:\markdown笔记\笔记图片\20\2\44.png)

2. 分别为135和137进行上述配置。

2. 课程配置图片

   ![](E:\markdown笔记\笔记图片\20\2\45.png)
