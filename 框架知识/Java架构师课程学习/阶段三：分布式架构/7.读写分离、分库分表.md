...
2. 配置sharding-jdbc.xml文件：
   ...
   <beans xmlns="http://www.springframework.org/schema/beans"
       ...
       <bean id="ds0" class="com.zaxxer.hikari.HikariDataSource" destroy-method="close">
           ...
           <property name="jdbcUrl" value="jdbc:mysql://192.168.156.139:3306/sharding_orders_139?serverTimezone=Asia/Shanghai&amp;useSSL=false" />
       ...
       <bean id="ds1" class="com.zaxxer.hikari.HikariDataSource" destroy-method="close">
           <property name="driverClassName" value="com.mysql.cj.jdbc.Driver" />
           <property name="jdbcUrl" value="jdbc:mysql://192.168.156.140:3306/sharding_orders_140?serverTimezone=Asia/Shanghai&amp;useSSL=false" />
           <property name="username" value="root" />
           <property name="password" value="fx1212" />
       </bean>
