...
* Java8废弃了分段锁的方案，直接使用一个大数组，并对哈希碰撞下的寻址做了优化，当链表的长度超过一定值（默认8），列表将转换成红黑树，寻址的时间复杂度从O(n)降为O(logn)；
  ...
  ![](E:\markdown笔记\笔记图片\8\52.webp)

### 10-5 多线程并发与线程安全总结

![](E:\markdown笔记\笔记图片\8\53.png)
...
![](E:\markdown笔记\笔记图片\8\70.png)

![71](E:\markdown笔记\笔记图片\8\71.png)
...
![](E:\markdown笔记\笔记图片\8\79.png)

这个算法虽然简单，但是有一个十分致命的问题，那就是临界问题，如下图：

![](E:\markdown笔记\笔记图片\8\80.png)
